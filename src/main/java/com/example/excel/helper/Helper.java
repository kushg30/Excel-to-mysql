...
public class Helper {
	...
	// checks if file is of excel type or not
	...
	public static List<Product> convertToListOfProduct(InputStream is) {
			...
			while (iterator.hasNext()) {
				...
				while (cells.hasNext()) {
					...
					case 0:
						...
						break;
					case 1:
						p.setProductName((String) cell.getStringCellValue());
						break;
					case 2:
						p.setProductDesc((String) cell.getStringCellValue());
						break;
					case 3:
